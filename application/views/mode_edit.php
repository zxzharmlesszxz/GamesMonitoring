...
<tbody>
 <tr>
  <td>
   <label for="shortname">Shortname</label></td><td><input type="text" value="$data->shortname" name="mode[shortname]"/>
  </td>
 </tr>
 <tr>
  <td>
   <label for="fullname">Fullname</label></td><td><input type="text" value="$data->fullname" name="mode[fullname]"/>
  </td>
 </tr>
 <tr>
  <td>
